...
public class DocuportConstants {
    public static final String LOGIN = "b1g2_client@gmail.com";
    public static final String PASSWORD = "Group2";
    public static final String LOGGED_URL = "https://beta.docuport.app/";
    public static final String LOGOUT_URL = "https://beta.docuport.app/login";
